...
public class NpgDocumentRepositoryIntegrationTests
{
    ...
    private static List<DocumentModel> _documentData =>
        ...
        {
            new DocumentModel("author one", DateTime.Parse("01-01-2020 12:30:00"), (long)1234, "/path/to/document/document", 1, "summary one", "title one", 123456, 0, null, 0),
            new DocumentModel("author two", DateTime.Parse("02-02-2020 13:40:00"), (long)2345, "/path/to/document/secondDocument", 2, "summary two", "title two", 550, 0, null, 0),
            new DocumentModel("author three", DateTime.Parse("03-03-2020 14:50:00"), (long)3456, "path/to/document/thirdDocument", 1, "summary three", "title three", 600000, 0, null, 0),
            new DocumentModel("Maja Lærke Maach", DateTime.Parse("2022-10-07T13:40:00"), 1, "https://www.dr.dk/nyheder/seneste/iran-haevder-mahsa-amini-doede-af-organsvigt", 1, "", "Iran hævder, at Mahsa Amini døde af organsvigt", 0, 0, null, 0),
            new DocumentModel("Maja Lærke Maach", DateTime.Parse("2022-10-07T13:33:00"), 2, "https://www.dr.dk/nyheder/seneste/kongehuset-dronningen-har-talt-med-prins-joachim-paa-fredensborg-slot", 1, "", "Kongehuset: Dronningen har talt med prins Joachim på Fredensborg Slot", 0, 0, null, 0),
            new DocumentModel("Mette Stender Pedersen", DateTime.Parse("2022-10-07 05:01:00"), 4, "https://nyheder.tv2.dk/live/2022-10-07-nyhedsoverblik#entry=3830920", 2, "", "Eks-landsholdsatlet skal i fængsel for grov vold og voldtægt", 0, 0, null, 0),
            new DocumentModel("Jonathan Kjær Troelsen", DateTime.Parse("2022-10-03 09:01:00"), 5, "https://nyheder.tv2.dk/lokalt/2022-10-03-folk-stod-i-timelange-koeer-for-vacciner", 2, "", "Folk stod i timelange køer for vacciner", 0, 0, null, 0),
            new DocumentModel("Jonathan Kjær Troelsen", DateTime.Parse("2022-10-03 09:01:00"), 1234, "https://nyheder.tv2.dk/lokalt/2022-10-03-folk-stod-i-timelange-koeer-for-vacciner", 2, "", "Folk stod i timelange køer for vacciner", 0, 0, null, 0),
        };
